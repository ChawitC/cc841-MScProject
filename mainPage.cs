...
namespace cc841.MScProject
{
    public partial class mainPage : Form
    {
        ...
        // The name of the LUTs is in the format of Ref[x][y]” where x and y represent coordinates.
        // Refer to Page 52; Figure 38 of the report for the illustration
        ...
        int[] Ref32 = new int[64] { 0, 0, 56, 148, 198, 198, 148, 56, 0, 56, 198, 314, 382, 382, 314, 198, 0, 148, 314, 462, 563, 563, 462, 314, 14, 198, 382, 563, 722, 722, 563, 198, 14, 198, 382, 563, 722, 722, 563, 198, 0, 148, 314, 462, 563, 563, 462, 148, 0, 56, 198, 314, 382, 382, 314, 198, 0, 0, 56, 148, 198, 198, 148, 56 };
        ...
        // Row 4 of 5
        int[] Ref03 = new int[64] { 0, 14, 14, 0, 0, 0, 0, 0,148, 198, 198, 148, 56, 0, 0, 0,314, 382, 382, 314, 198, 56, 0, 0,462, 563, 563, 462, 314, 148, 0, 0,563, 722, 722, 563, 382, 198, 14, 0,563, 722, 722, 563, 382, 198, 14, 0,462, 563, 563, 462, 314, 148, 0, 0,314, 382, 382, 314, 198, 0, 0, 0 };
        ...
        /*
         * Insert new array of int[64] here to preload additional patterns into the program
         * example:
         * int[] NewRef1 = new int[64] {...}
         * int[] NewRef2 = new int[64] {...}
         * int[] NewRef3 = new int[64] {...}
         */
        ...
        public mainPage()
        {
            ...
            /* For simplicity in adding new moving shape (dynamic patterns; movie)
             * comment out one of the presets and load the newly created value into the array list
             * Example:
             * savedArrayList3.Add(NewRef1);
               savedArrayList3.Add(NewRef2);
               savedArrayList3.Add(NewRef3);
             */
            ...
            statusMessagesTextBox.AppendText(Environment.NewLine + "-- Ready --");
        }
        ...
        private void PresetsButton_Click(object sender, EventArgs e)
        {
            ...
            loopStepLabel.Enabled = false;
            loopStepLabel.Text = "N/A";
            fakeConfirmButton.Enabled = false;
            persistentIndex = 0;
            ...
            else if (((Button)sender).Tag.ToString() == "p3")
            {
                ...
                loopStepLabel.Enabled=true;
                loopStepLabel.Text = "1 / 3";
                fakeConfirmButton.Enabled = true;
        ...
        private void Button_Click(object sender, EventArgs e)
        {
            ...
            if (!cloneMode && (workspaceArray[arrayIndex] != selectedColor))// Input value from trackBar
            {
                ...
                //statusMessagesTextBox.AppendText(Environment.NewLine + "(New) Undo Stack Size:" + historyUndoStack.Count.ToString() + " | Redo Stack Size:" + historyRedoStack.Count.ToString()); 
        ...
        private void cloneModeCheckbox_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (cloneMode) { valueSectionPictureBox.BackColor = SystemColors.Desktop; }
            else { valueSectionPictureBox.BackColor = SystemColors.GradientActiveCaption; }
        }
        ...
        private async void loopStartStopButton_Click(object sender, EventArgs e)
        {
            ...
            while (looping && (selectedPattern == 3 || selectedPattern == 4 || selectedPattern == 5 || selectedPattern == 6))
            {
                if (selectedPattern == 3)
                {
                    ...
                    loopStepLabel.Text = (persistentIndex + 1).ToString() + " / 3";
                ...
                else if (selectedPattern == 5)
                {
                    ...
                    loopStartStopButton.Text = "❚❚";
                    loopStepLabel.Text = (persistentIndex + 1).ToString() + " / 6";
                    await PutTaskDelay(selectedLatency);
                    if (!looping) { loopStartStopButton.Text = "▶"; break; }
                }
                else if (selectedPattern == 6)
                {
                    ...
                    loopStartStopButton.Text = "❚❚";
                    loopStepLabel.Text = (persistentIndex + 1).ToString() + " / 16";
                    await PutTaskDelay(selectedLatency);
                    if (!looping) { loopStartStopButton.Text = "▶"; break; }
                }
                persistentIndex++;
        ...
        private void loopLatencyTextBox_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            if (e.KeyChar == (char)Keys.Enter)
            {
                ...
                else if (lastConfirmedLatency != textBoxValue)
                {
                    selectedLatency = textBoxValue;
                    lastConfirmedLatency = textBoxValue;
                    e.Handled = true; //To suppress the Ding sounds, indicating that there is no error.
